...
int main() {
  ...
  // Alocação de memória para guardar os valores
   ...
   qsort(valores, n, sizeof(float), decrescente); //Função que ordena os valores.
...
int decrescente(const void* a, const void* b) { //Função de comparação que vai retornar um valor para a função qsort.
